...
export async function getStaticProps() {
  ...
  const [seo, news, events, locations, corePractices] = await Promise.all([
    ...
    fetch('https://wp.scarincihollenbeck.com/wp-json/wp/v2/posts?categories=98&_embed', { headers }).then((data) => data.json()),
    fetch('https://wp.scarincihollenbeck.com/wp-json/wp/v2/posts?categories=99&_embed', { headers }).then((data) => data.json()),
