...
export default function CyberSecurityClientAlert({ post }) {
      ...
      {(post === undefined && router.isFallback) ? (
        ...
        <>
          <NextSeo
            ...
            canonical={`https://scarincihollenbeck.com/cyber-security-client-alert/${post.seo.canonicalLink}`}
            openGraph={{
            ...
            twitter={{
              handle: '@S_H_Law',
              site: `https://scarincihollenbeck.com/cyber-security-client-alert/${post.seo.canonicalLink}`,
