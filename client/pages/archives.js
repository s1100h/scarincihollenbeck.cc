...
export default function ArchivesLandingPage({
  ...
  const { data: archivesPosts, error: archivesPostsError } = useSWR(`https://wp.scarincihollenbeck.com/wp-json/search/query/${router.query.q}/${router.query.page}`, fetcher);
