...
export async function getStaticProps({params}) {
  ...
  const firmOverviewResponse = await fetch(`${process.env.REACT_APP_CACHED_API}/cached/firm-overview`, { headers });
  const firmOverviewJson = await firmOverviewResponse.json();
