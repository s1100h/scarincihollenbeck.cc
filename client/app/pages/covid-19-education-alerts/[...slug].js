      ...
      {(post === undefined && slides === undefined) ? (
        ...
        <>
          <Head>
            ...
            <meta property="og:url" content={`https://scarincihollenbeck.com/covid-19-education-alerts/${post.seo.canonicalLink}`} />
            ...
            <meta property="og:image:secure_url" content={`https://scarincihollenbeck.com/covid-19-education-alerts/${post.seo.canonicalLink}`} />
            ...
            <script type="application/ld+json">
              {`
                ...
                "url": "https://scarincihollenbeck.com/covid-19-education-alerts/${post.seo.canonicalLink}",
...
export async function getStaticPaths() {
  const postsResponse = await fetch(`${process.env.REACT_APP_WP_BACKEND}/wp-json/single/list/covid-19-education-alerts`, { headers });
  const postsJson = await postsResponse.json();

  return  {
    paths: postsJson.map(link => `/covid-19-education-alerts/[...slug]/${link}`) || [],
    fallback: true,
  }
}
