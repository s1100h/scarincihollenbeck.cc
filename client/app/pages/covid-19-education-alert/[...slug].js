      ...
      {(post === undefined && router.isFallback) ? (
        ...
        <>
          <NextSeo
            ...
            canonical={`https://scarincihollenbeck.com/covid-19-education-alert/${post.seo.canonicalLink}`}
            openGraph={{
              url: `https://scarincihollenbeck.com/covid-19-education-alert/${post.seo.canonicalLink}`,
              title: post.seo.title,
              description: post.seo.metaDescription,
              type: 'article',
              article: {
            ...
            twitter={{
              handle: '@S_H_Law',
              site: `https://scarincihollenbeck.com/covid-19-education-alert/${post.seo.canonicalLink}`,
