    ...
    <div>
      <div className="tab-content">
        ...
        { (blogPosts) && <Articles
          ...
          />}
        { (newsEventArticles.length > 0) && (newsEventArticles !== undefined) && <Articles
            currentTab={currentTab}
            tabTitle="newsevents"
            title="News &amp; Events"
        ...
        { (videos) && <VideoContent
            ...
            tabTitle="videos"
          />}
        { (tabs) && filterBody.map((b) => <BasicContent
