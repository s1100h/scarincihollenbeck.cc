      ...
      {(post === undefined && slides === undefined) ? (
        ...
        <>
          <Head>
            ...
            <meta property="og:url" content={`https://scarincihollenbeck.com/headlines/${post.seo.canonicalLink}`} />
            ...
            <meta property="og:image:secure_url" content={`https://scarincihollenbeck.com/headlines/${post.seo.canonicalLink}`} />
            ...
            <script type="application/ld+json">
              {`
                ...
                "url": "https://scarincihollenbeck.com/headlines/${post.seo.canonicalLink}",
