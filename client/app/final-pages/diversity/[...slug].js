...
export default function Diversity({ slides, post }){ 
      ...
      {(post === undefined && slides === undefined) ? (
        ...
        <>
          <Head>
            ...
            <meta property="og:url" content={`https://scarincihollenbeck.com/diversity/${post.seo.canonicalLink}`} />
            ...
            <meta property="og:image:secure_url" content={`https://scarincihollenbeck.com/diversity/${post.seo.canonicalLink}`} />
            ...
            <script type="application/ld+json">
              {`
                ...
                "url": "https://scarincihollenbeck.com/diversity/${post.seo.canonicalLink}",
...
export async function getStaticPaths() {
  const postsResponse = await fetch(`${process.env.REACT_APP_WP_BACKEND}/wp-json/single/list/diversity`, { headers });
  const postsJson = await postsResponse.json();

  return  {
    paths: postsJson.map(link => `/diversity/[...slug]/${link}`) || [],
    fallback: true,
  }
}
