...
export default function CovidAlerts({ slides, post }){ 
      ...
      {(post === undefined && slides === undefined) ? (
        ...
        <>
          <Head>
            ...
            <meta property="og:url" content={`https://scarincihollenbeck.com/covid-19-alerts/${post.seo.canonicalLink}`} />
            ...
            <meta property="og:image:secure_url" content={`https://scarincihollenbeck.com/covid-19-alerts/${post.seo.canonicalLink}`} />
            ...
            <script type="application/ld+json">
              {`
                ...
                "url": "https://scarincihollenbeck.com/covid-19-alerts/${post.seo.canonicalLink}",
...
export async function getStaticPaths() {
  const postsResponse = await fetch(`${process.env.REACT_APP_WP_BACKEND}/wp-json/single/list/covid-19-alerts`, { headers });
