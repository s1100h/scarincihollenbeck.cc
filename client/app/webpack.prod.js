...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.REACT_APP_CACHED_API': JSON.stringify('http://142.93.73.211:8200'),
      'process.env.REACT_APP_FORMS_API': JSON.stringify('http://142.93.73.211:8000'),
      'process.env.REACT_APP_FEED_API': JSON.stringify('http://142.93.73.211:8100')
    }),
