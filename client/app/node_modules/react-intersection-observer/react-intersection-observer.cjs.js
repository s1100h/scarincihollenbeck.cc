...
function observe(element, callback, options) {
  ...
  !!INSTANCE_MAP.has(element) ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, "react-intersection-observer: Trying to observe %s, but it's already being observed by another instance.\nMake sure the `ref` is only used by a single <Observer /> instance.\n\n%s") : invariant__default['default'](false) : void 0;
  /* istanbul ignore if */
...
var InView = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    !this.node ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, "react-intersection-observer: No DOM node found. Make sure you forward \"ref\" to the root DOM element you want to observe.") : invariant__default['default'](false) : void 0;
  };
