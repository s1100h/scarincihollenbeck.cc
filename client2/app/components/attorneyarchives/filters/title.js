...
export default function Title(props) {
  ...
  return (
    <NavDropdown title={<>Filter by title <FontAwesomeIcon icon={faCaretDown} className="ml-5 icon-w8px-h20px" /></>} id="basic-nav-dropdown" className="bg-white rounded p-sm-3 p-md-0">      
