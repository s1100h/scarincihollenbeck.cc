...
function FirmEvents({ slides, post, router }){ 
...
export async function getStaticPaths() {
  const postsResponse = await fetch(`${process.env.REACT_APP_ADMIN_SITE}/wp-json/single/list/firm-events`, { headers });
...
export default withRouter(FirmEvents);