...
export default function Attorney({slides, bio }) {
  ...
  const sortedBlogArticles = sortByDateKey(bio.blogPosts, 'date');
        ...
        <Container>
          <Row>
            ...
            <Col sm={12} md={9} className="mt-4">
              ...
              { (bio.blogPosts) && (bio.blogPosts.length > 0) && <RelatedArticles title="Recent Articles" content={sortedBlogArticles} />} 
            </Col>
