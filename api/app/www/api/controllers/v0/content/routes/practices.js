...
router.get('/practice-page', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const practicePage = yield redis_utils_1.getAsync('practicePage');
        // // parse strings to JSON objects
        const parsedPracticePage = redis_utils_1.parseResults(practicePage);
...
exports.PracticePageRouter = router;
