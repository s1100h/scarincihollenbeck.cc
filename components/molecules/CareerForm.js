...
import {
  THANKS_MESSAGE, inputsCareerForm, GET_IN_TOUCH_FORM_API, RECAPTCHA_SITE_KEY,
...
const CareerForm = () => {
  ...
  return (
    <FormContainer isPositionRelative>
      <KwesScripts />
      <TwoColumnsForm action={GET_IN_TOUCH_FORM_API} className="kwes-form d-print-none w-100" has-recaptcha-v3="true" recaptcha-site-key={RECAPTCHA_SITE_KEY} success-message={THANKS_MESSAGE.title}>
        <div className="career-form-wrapper">
          <RenderInputs arrayOfAttributes={inputsCareerForm} attorneySlug={router.asPath} />
        </div>
