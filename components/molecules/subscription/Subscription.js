...
const Subscription = () => (
  <GradientSubscriptionBox>
    ...
    <p>Consider subscribing to our Firm Insights mailing list by clicking the button below so you can keep up to date with the firm`s latest articles covering various legal topics.</p>
    <SubscriptionModal />
  </GradientSubscriptionBox>
);
