  ...
  <Container>
    ...
    <Row>
      <Col sm={12} className="my-4">
        ...
        <div>
          <p>
            3. Your website profile will have a contact form. How do you want information submitted
            to that contact form be received?
          </p>
    ...
    <Row>
      ...
      >
        ...
        <p style={{ fontSize: '18px' }}>
          <em>
            ** Contact forms on the website are action tags for cold leads. The marketing department
            will monitor all leads that come through the website.
          </em>
        </p>
        <h3 className="mt-3 mb-4">
          <strong>
            If there is any information that is missing or something you&apos;d like to add to your
            bio. Please provide that informations here.
          </strong>
        </h3>
        <textarea
          type="textarea"
