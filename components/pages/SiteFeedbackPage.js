  ...
  <Container>
    ...
    <Row>
      <Col sm={12} className="my-4">
        ...
        <p className="mt-3" style={{ fontSize: '1.8rem', lineHeight: '1.2' }}>
          <strong>
            Hello, we are seeking your input regarding your information
            displayed on Scarincihollenbeck.com.
          </strong>
        </p>
        <p>
        ...
        <p>
          1. Select up to five of your core practice groups that should be
          listed on your website profile
        </p>
        <p>
          2. Select any additional practices where you would like to be listed
          on that practices&apos; page
        </p>
        <div>
          <p>
            3. Your website profile will have a contact form. How do you want
            information submitted to that contact form be received?
          </p>
    ...
    <Row>
      ...
      >
        ...
        <h3>
          <strong>
            2. What 5 core practices would you like to highlight on your
            attorney profile?
          </strong>
        </h3>
          ...
          <ul className="col-list list-unstyled mx-0 px-0 mt-2">
            {practices.map((practice) => (
              <li key={practice} style={{ marginBottom: '5px' }}>
                ...
                />
                <label htmlFor="practices-for-attorney-profiles">
                  {practice}
                </label>
              </li>
            ))}
        ...
        <h3>
          <strong>
            4. Who would you like to receive contact inquiries from your
            attorney profile on the website?
          </strong>
        </h3>
        <fieldset data-kw-group data-kw-rules="required">
          ...
          <div className="mb-2">
            <input
              type="radio"
              name="recieve-profile-messages"
              value="Your secretary"
            />
            {' '}
            Your secretary
          </div>
        ...
        <p style={{ fontSize: '18px' }}>
          <em>
            ** Contact forms on the website are action tags for cold leads. The
            marketing department will monitor all leads that come through the
            website.
          </em>
        </p>
        <h3 className="mt-3 mb-4">
          <strong>
            If there is any information that is missing or something you&apos;d
            like to add to your bio. Please provide that informations here.
          </strong>
        </h3>
        <textarea
          rows="20"
