...
const SiteFormPage = ({
  attorney, setAttorney, attorneys, practices, isNewAttorney,
}) => {
  useEffect(() => {
    kwesforms.init();
  }, []);
  ...
  return (
    <Container>
      ...
      <Row>
        <Col sm={12} className="my-4">
          ...
          <p className="mt-3" style={{ fontSize: '1.8rem', lineHeight: '1.2' }}>
            <strong>Hello, we are seeking your input regarding your information displayed on Scarincihollenbeck.com.</strong>
          </p>
          <p>
      ...
      <Row>
        <form className="mt-2 kwes-form" action="https://kwes.io/api/foreign/forms/JuFmpokXEypi5BKw2mXO" has-recaptcha-v3="true" recaptcha-site-key="6LeC96QZAAAAACJ64-6i0e-wibaQpwEpRPcnWNdY">
          {isNewAttorney ? <NewAttorneyNameForm attorney={attorney} setAttorney={setAttorney} /> : <CurrentAttorneyNameForm attorneys={attorneys} attorney={attorney} setAttorney={setAttorney} />}

          {attorney && (
            <>
              <input type="hidden" id="attorney-emai" name="attorney-email" value={attorneys.filter((a) => a.name === attorney).map((b) => b.email)} />
              <p className="mb-4">
          ...
          <h3>
            <strong>2. What 5 core practices would you like to highlight on your attorney profile?</strong>
          </h3>
          ...
          <h3>
            <strong>4. Who would you like to receive contact inquiries from your attorney profile on the website?</strong>
          </h3>
          ...
          <p style={{ fontSize: '18px' }}>
            <em>** Contact forms on the website are action tags for cold leads. The marketing department will monitor all leads that come through the website.</em>
          </p>
          <h3 className="mt-3 mb-4">
            <strong>If there is any information that is missing or something you&apos;d like to add to your bio. Please provide that informations here.</strong>
          </h3>
