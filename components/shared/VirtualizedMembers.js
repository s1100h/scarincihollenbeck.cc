...
} from '../../styles/VirtualizedMembers';
...
const VirtualizedMembers = ({ members, title }) => {
  ...
  return (
    <>
      ...
      <VirtualListContainer
        ref={parentRef}
        listHight={rowVirtualizer.totalSize}
      >
        <ul>
          {rowVirtualizer.virtualItems.map((virtualRow) => (
            ...
            >
              <AttorneyCard
                ...
                image={
                  members[virtualRow.index].image
                  || members[virtualRow.index].better_featured_image
                }
                name={
                  members[virtualRow.index].name
                  || members[virtualRow.index].title
                }
                designation={members[virtualRow.index].designation}
                number={
                  members[virtualRow.index].contact
                  || members[virtualRow.index].phone
                }
