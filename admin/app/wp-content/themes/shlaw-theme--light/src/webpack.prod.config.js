...
module.exports = {
  ...
  entry: {
    ...
    singleCareer: ['core-js/stable', './src/SingleCareer/index.js'],  
    singleLocation: ['core-js/stable', './src/SingleLocation/index.js'],    
  ...
  output: {
    ...
    publicPath: '/wp-content/themes/sh-law-theme-production/includes/assets/images/',
  },
  plugins: [
