                  ...
                  ? (
                    <nav aria-label="pagination">
                      <ul className="d-flex flex-wrap no-dots lead">
                        <li className="mr-2">
                          <a className="text-dark" href={`${window.location.origin}/quick-news/page/${prev}/`} tabIndex="-1" aria-label="previous link">
                        ...
                        {/** Current / First Number */}
                        {
                          pageNums.map(val => ((active === val) ? (
                            <li className={(active === val) ? 'active mr-2' : 'mr-2'} key={`page-${val}`}>
                              <a className="text-dark mt-2" href={`${window.location.origin}/quick-news/page/${val}/`}>{val}</a>
                            </li>
                          ) : ''))
                        }
                        {/** ... */}
                        ...
                        {/** Last Number */}
                        {
                          pageNums.map(val => (((pageNums.length -1) === val) ? (
                            <li className={(active === val) ? 'active mr-2' : 'mr-2'} key={`page-${val}`}>
                              <a className="text-dark" href={`${window.location.origin}/quick-news/page/${val}/`}>{val}</a>
                            </li>
                          ) : ''))
                        }
                        <li className="ml-1">
                          <a className="text-dark" href={`${window.location.origin}/quick-news/page/${next}/`} aria-label="next link">
