...
function practice_portal_page() 
{
  ...
  foreach($practice_ids as $id) {
    ...
    $page_content["seo"] = (object)array(
      "title" => "Attorney Legal Practices | Scarinci Hollenbeck",
      "metaDescription" => "Scarinci Hollenbeck attorneys provide a fully scaled platform of law practices for today's entrepreneurs in the New York and New Jersey area.",
      "canonicalLink" => "practices"
    );
